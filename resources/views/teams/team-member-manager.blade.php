                        ...
                        <div class="col-span-6 lg:col-span-4">
                            ...
                            <div
                                ...
                                @foreach ($this->roles as $index => $role)
                                    <button type="button"
                                            {{!$team->booth && $role->key == "booth_owner" ? 'disabled' : ''}}
                                        ...
                                        <div
                                            class="{{!$team->booth && $role->key == "booth_owner" ? 'opacity-50' : ''}} {{ isset($addTeamMemberForm['role']) && $addTeamMemberForm['role'] !== $role->key ? 'opacity-50' : '' }}">
                                            <!-- Role Name -->
                                            <div class="flex items-center">
                                                <div
                                            ...
                                            <div class="mt-2 text-xs text-gray-600 dark:text-gray-400 text-left">
                                                {{ $role->description }}
                                                @if(!$team->booth && $role->key == "booth_owner")
                                                    <br><br>
