                ...
                <x-action-section>
                    ...
                    <x-slot name="content">
                        ...
                        <div class="col-span-6 sm:col-span-4 pb-5">
                            ...
                            <x-input id="postcode" type="text" class="mt-1 block w-full" wire:model="team.postcode"
                                     autofocus/>
                            @error('team.description') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-6 sm:col-span-4 pb-5">
                            ...
                            <x-input id="house_number" type="text" class="mt-1 block w-full"
                                     wire:model="team.house_number"
                                     autofocus/>
                            @error('team.house_number') <p
                                class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-6 sm:col-span-4 pb-5">
                            <x-label for="street" value="{{ __('Street') }}"/>
                            <x-input id="street" type="text" class="mt-1 block w-full" wire:model="team.street"
                                     autofocus/>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <x-input id="website" type="text" class="mt-1 block w-full" wire:model="team.website"
                                     autofocus/>
