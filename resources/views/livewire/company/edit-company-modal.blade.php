            ...
            <dl class="sm:grid sm:grid-cols-3 sm:gap-6">
                ...
                <dd class="sm:col-span-2">
                    <textarea id="description" wire:model="form.description"
                              class="h-20 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full"
