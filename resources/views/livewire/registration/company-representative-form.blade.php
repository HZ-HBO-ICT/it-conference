        ...
        <form wire:submit="goNext" @submit.prevent>
            ...
            <div>
                ...
                <div class="flex items-center justify-end mt-4">
                    <!-- Existing content -->
                    <div>
                        <a class="text-sm text-waitt-pink underline hover:text-pink-700 transition-all rounded-md focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
