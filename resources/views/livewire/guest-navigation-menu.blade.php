    ...
    <div class="md:hidden" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1">
        <div class="bg-[rgba(7,14,28,0.95)] shadow-lg">
            <div class="px-4 pt-2 pb-3 space-y-1">
                <a href="{{ route('welcome') }}" class="block px-3 py-2 text-base font-normal text-white hover:text-gray-200 transition-colors duration-200 {{ request()->routeIs('welcome') ? 'text-brand-yellow font-bold' : '' }}">Home</a>
                <a href="{{ route('speakers.index') }}" class="block px-3 py-2 text-base font-normal text-white hover:text-gray-200 transition-colors duration-200 {{ request()->routeIs('speakers.index') ? 'text-brand-yellow font-bold' : '' }}">Speakers</a>
                <a href="{{ route('programme') }}" class="block px-3 py-2 text-base font-normal text-white hover:text-gray-200 transition-colors duration-200 {{ request()->routeIs('programme') ? 'text-brand-yellow font-bold' : '' }}">Presentations</a>
                <a href="{{ route('companies.index') }}" class="block px-3 py-2 text-base font-normal text-white hover:text-gray-200 transition-colors duration-200 {{ request()->routeIs('companies.index') ? 'text-brand-yellow font-bold' : '' }}">Companies</a>
                <a href="{{ route('faq') }}" class="block px-3 py-2 text-base font-normal text-white hover:text-gray-200 transition-colors duration-200 {{ request()->routeIs('faq') ? 'text-brand-yellow font-bold' : '' }}">FAQ</a>
                <a href="{{ route('contact') }}" class="block px-3 py-2 text-base font-normal text-white hover:text-gray-200 transition-colors duration-200 {{ request()->routeIs('contact') ? 'text-brand-yellow font-bold' : '' }}">Contact</a>
                <a href="{{ route('login') }}" class="block px-3 py-2 text-base font-normal text-white hover:text-gray-200 transition-colors duration-200 {{ request()->routeIs('login') ? 'text-brand-yellow font-bold' : '' }}">Login</a>
            </div>
        </div>
    </div>
</nav>
