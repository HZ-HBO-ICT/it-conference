<div class="tooltip">
    ...
    @if(!$isReadyToBePublished)
        <div class="tooltiptext text-xs">To publish the programme you must:<br>
            <span class="{{$allPresentationsAreApproved ? 'text-green-500' : 'text-red-500'}}">1) have no pending presentations for approval</span><br>
            <span class="{{$allPresentationsAreScheduled ? 'text-green-500' : 'text-red-500'}}">2) schedule all approved presentations</span>
        </div>
    @endif
</div>
