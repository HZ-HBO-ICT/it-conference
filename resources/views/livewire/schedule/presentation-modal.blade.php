<x-livewire-modal>
            ...
            @if(!\App\Models\Edition::current()->is_final_programme_released)
                <dl class="sm:grid sm:grid-cols-3 sm:gap-6">
                    ...
                    <dd class="sm:col-span-2">
                        ...
                        <input
                            class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-crew-500 dark:focus:border-crew-600 focus:ring-crew-500 dark:focus:ring-crew-600 rounded-md shadow-xs mt-1 block"
    ...
    <x-slot name="buttons" class="dark:bg-gray-900">
        ...
        <button wire:click="remove"
                class="mr-3 inline-flex items-center px-4 py-2 bg-red-800 dark:bg-red-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 dark:hover:bg-red-800 focus:bg-red-700 dark:focus:bg-red-800 active:bg-red-900 dark:active:bg-red-300 focus:outline-hidden focus:ring-2 focus:ring-crew-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
            Remove
        </button>
        @if(!\App\Models\Edition::current()->is_final_programme_released)
            <button wire:click="save"
                    class="inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-hidden focus:ring-2 focus:ring-crew-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                Save
            </button>
        @endif
    </x-slot>
