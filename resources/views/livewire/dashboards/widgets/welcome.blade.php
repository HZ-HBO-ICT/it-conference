<div class="relative w-full h-full bg-radial-[at_90%_105%] from-cyan-900 to-[#060916] to-65% rounded rounded-lg hover:cursor-pointer text-gray-500"
    ...
    <div class="pt-5 pl-5">
        ...
        <p class="text-gray-300 w-3/4">Manage your team, presentations, and booth — all in one place.</p>
    </div>
    <p class="absolute bottom-5 left-5 text-xs flex items-center">
