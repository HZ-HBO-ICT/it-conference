<div class="w-full h-full flex items-center flex-row-reverse rounded-lg bg-radial-[at_50%_120%] from-[#1B0630] to-[#0B0B0B] to-90%">
    <div class="hidden md:block mr-2 p-2 rounded-lg bg-fuchsia-600">
    ...
    <div class="flex-1 ml-5 text-white items-start text-left">
        ...
        <p class="text-xs md:text-sm md:font-bold text-{{\App\Enums\ApprovalStatus::colorFromValue($status)}}-200">{{ ucfirst(str_replace('_', ' ', $status)) }}</p>
    </div>
</div>
