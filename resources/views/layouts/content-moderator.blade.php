                    ...
                    <ul class="gap-y-7 flex-col flex-1 flex" role="list">
                        ...
                        <li>
                            <ul class="-mx-2" role="list">
                                <x-sidebar-link-content-mod :label="'Dashboard'" :route="'moderator.overview'"/>
                                <x-sidebar-link-content-mod :label="'Company requests'" :route="'moderator.requests'" :param="'teams'"/>
                                <x-sidebar-link-content-mod :label="'Presentation requests'" :route="'moderator.requests'" :param="'presentations'"/>
                                <x-sidebar-link-content-mod :label="'Booth requests'" :route="'moderator.requests'" :param="'booths'"/>
                                <x-sidebar-link-content-mod :label="'Sponsorship requests'" :route="'moderator.requests'" :param="'sponsorships'"/>
                                <x-sidebar-link-content-mod :label="'Schedule management'" :route="'moderator.schedule.overview'"/>
                            </ul>
                        </li>
                        <!-- Profile Links -->
                        <li>
