            ...
            <div class="mx-auto w-full max-w-(--breakpoint-xl)">
                <div class="grid grid-cols-2 mt-8 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    ...
                    <div class="text-gray-100">
                        <h1 class="text-xl font-bold py-2">Let's Stay Connected</h1>
                        <p class="pb-2">Follow us on social media to stay updated with the latest news and announcements.</p>
                        <hr/>
                        <h1 class="text-xl font-bold py-2">Follow us</h1>
                        <div class="flex mt-4 sm:justify-left md:mt-0 space-x-5 rtl:space-x-reverse">
                            <a href="https://www.linkedin.com/company/we-are-in-it-together-conference/" target="_blank" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                                <svg class="w-7 h-7 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    <path
                                        d="M100.3 448H7.4V148.9h92.9zM53.8 108.1C24.1 108.1 0 83.5 0 53.8a53.8 53.8 0 0 1 107.6 0c0 29.7-24.1 54.3-53.8 54.3zM447.9 448h-92.7V302.4c0-34.7-.7-79.2-48.3-79.2-48.3 0-55.7 37.7-55.7 76.7V448h-92.8V148.9h89.1v40.8h1.3c12.4-23.5 42.7-48.3 87.9-48.3 94 0 111.3 61.9 111.3 142.3V448z" />
                                </svg>
                                <span class="sr-only">Linkedin</span>
                            </a>
                            <a href="https://www.instagram.com/weareinittogetherhz/" target="_blank" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-7 h-7 fill-white" viewBox="0 0 16 16">
                            ...
                            <a href="https://github.com/HZ-HBO-ICT/it-conference" target="_blank" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                                <svg class="w-7 h-7 fill-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                     fill="currentColor"
                                     viewBox="0 0 20 20">
                ...
                <div class="px-4 py-3 md:flex md:items-center md:justify-between">
                    <span class="text-sm text-gray-300 sm:text-center"> © 2026 We are in IT Together Conference | Made by IT-Conference Website Team
                    </span>
                </div>
            </div>
        </footer>
