<x-app-layout>
    ...
    <div class="relative w-full py-10 pr-10">
        <div
            class="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-500 py-10 px-10 opacity-75"></div>
                    ...
                    <div class="w-4/5 basis-1/4 hidden lg:block md:block">
                        <div
                            ...
                            <div class="px-3 py-4 bg-gray-50 dark:bg-gray-800">
                                <ul class="space-y-2">
                                    <x-sidebar-link :label="'Announcements'" :route="'announcements'"/>
                                    <x-sidebar-link :label="'My Profile'" :route="'my-profile'"/>
                                    <x-sidebar-link :label="'My Programme'" :route="'my-programme'"/>
                                    <li class="pt-24">
