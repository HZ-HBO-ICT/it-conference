    ...
    <div class="py-16">
        <div class="flex flex-row gap-8">
            ...
            <div class="w-fit basis-1/4 hidden pl-8 lg:block md:block">
                <div class="bg-white dark:bg-gray-800 h-fit sticky overflow-hidden sm:rounded-lg shadow-xl">
                    <div class="px-3 py-4 bg-gray-50 dark:bg-gray-800">
                        <ul class="space-y-2">
                            <li>
                                <a href="{{ route('announcements') }}"
                                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group @if(request()->routeIs('announcements')) dark:bg-gray-700 @endif">
                            ...
                            <li>
                                <a href="{{ route('my-profile') }}"
                                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group @if(request()->routeIs('my-profile')) dark:bg-gray-700 @endif">
                                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            ...
                            <li>
                                <a href="{{ route('my-programme') }}"
                                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group @if(request()->routeIs('my-programme')) dark:bg-gray-700 @endif">
                                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
