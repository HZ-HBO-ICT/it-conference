            ...
            <div id="form-slide h-full w-full"
                ...
                <div class="w-full">
                    <div class="text-center md:text-left text-black dark:text-gray-100 w-full pb-5">
                        <h2 class="text-3xl pt-5 font-semibold">Company Registration</h2>
                        <h2 class="text-xl">Please add the company representative details</h2>
                        <div class="w-full">
                            <form method="POST" action="{{route('register')}}">
                                @csrf
                                <input class="hidden" name="registration_type" value="'company_representative'">
                                <div class="mt-5">
