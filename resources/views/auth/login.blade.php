<x-app-layout>
    <div class="h-screen relative overflow-hidden mx-auto px-0 md:px-4 pt-14 pb-24">
        ...
        <div class="relative h-full flex items-center justify-center max-w-7xl mx-auto px-0 md:px-4">
            <div
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div class="flex flex-col md:flex-row items-center justify-between mt-6 space-y-3 md:space-y-0">
                            <div class="grid space-y-2">
                                <div class="text-sm text-gray-100">No account? Register as
