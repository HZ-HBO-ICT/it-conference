...
<x-app-layout>
    <div class="container h-screen mx-auto px-6 py-12">
        <h2 class="text-center text-waitt-yellow text-4xl font-extrabold bg-clip-text bg-linear-to-r from-pink-400 via-purple-400 to-blue-400 mb-12">
            Programme / <span class=" font-bold text-waitt-pink">{{$presentation->name}}</span>
        </h2>
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-5 px-6 pb-5">
                ...
                <div class="sm:col-span-2 text-waitt-pink">
                    ...
                    <div class="mt-5">
                        ...
                        <div
                            class="text-yellow-500 flex transititext-primary text-primary transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600 p-2"
