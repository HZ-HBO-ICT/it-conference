                        ...
                        <div class="px-6 py-5 bg-white dark:bg-slate-700 border-b dark:border-gray-500">
                            <div class="flex-nowrap justify-between items-center flex -mt-2 -ml-4">
                                ...
                                <div class="shrink-0 mt-2 ml-4">
                                    <!-- Add hover effects -->
                                    <a href="{{route('teams.create', ['teams'])}}" class="shadow-xs dark:shadow-s text-white font-semibold text-sm py-2 px-3 bg-crew-400 rounded-md items-center inline-flex relative">
                                        Create new company
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <div class="justify-between flex mt-2">
                                                <div class="flex">
                                                    <div class="text-gray-700 dark:text-white text-m items-center flex">
                                                        <svg class="shrink-0 w-6 h-6 mr-1.5 block stroke-crew-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23 23" fill="none" aria-hidden="true">
