<x-hub-layout>
    <div class="min-h-screen relative overflow-hidden py-6 sm:py-8 px-4 sm:px-6 md:px-8 bg-waitt-dark">
        ...
        <div class="relative z-10">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-2">Users</h2>
            <p class="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8">Manage user accounts and permissions</p>
