        ...
        <div class="pt-5">
            <x-list-section>
                ...
                <x-slot name="content">
                        ...
                        <x-list-section-item class="{{ !$company->is_approved ? 'bg-crew-300 bg-opacity-30 dark:bg-opacity-20' : '' }} border-l-4 {{ !$company->is_approved ? 'border-crew-300 dark:border-crew-600' : 'border-transparent' }}"
                                ...
                                <div class="justify-between flex my-0.5">
                                        ...
                                        <div class="text-gray-700 dark:text-white text-m items-center flex">
                                            ...
                                            @else
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                     stroke-width="1.5"
                                                     stroke="gray" aria-hidden="true" class="w-6 h-6 {{ !$company->is_approved ? 'stroke-gray-900 dark:stroke-white' : 'stroke-crew-300' }}">
                                    ...
                                    <div class="text-sm items-center flex ml-2 dark:text-white">
                                        <svg class="shrink-0 w-6 h-6 mr-1.5 block stroke-crew-300 {{ !$company->is_approved ? 'stroke-gray-900 dark:stroke-white' : '' }}" xlmns="http://www.w3.org/2000/svg" viewbox="0 0 23 23" fill="none" aria-hidden="true">
