...
<!-- Potential dynamic classes: bg-crew-600 dark:bg-crew-600 bg-violet-600 dark:bg-violet-600 bg-partner-600 dark:bg-partner-600 bg-participant-400 -->

<div
    class="w-full rounded overflow-hidden shadow-lg bg-{{$colorName}}-400 transition-all duration-300 transform hover:scale-105 hover:cursor-pointer">
    <div class="px-3 py-1">
