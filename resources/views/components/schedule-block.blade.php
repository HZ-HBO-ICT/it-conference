...
<div
    class="w-full rounded overflow-hidden bg-{{$colorName}}-500 hover:cursor-pointer hover:bg-gradient-to-r hover:from-{{$colorName}}-500 hover:to-{{$colorName}}-700 hover:transition-all hover:duration-300 hover:ease-in-out">
    <div class="px-3 py-1">
