...
@php
    $classes = ($active ?? false)
                 ? 'inline-flex items-center px-1 pt-1 border-indigo-400 dark:border-indigo-600 text-base font-medium leading-5 text-gray-900 dark:text-gray-100 focus:outline-hidden focus:border-indigo-700 transition duration-150 ease-in-out'
