        ...
        @if(Edition::current())
            @can('viewAny', \App\Models\Company::class)
                <x-sidebar-link-content-mod
                    ...
                    :badgeText="\App\Models\Company::hasStatus(ApprovalStatus::AWAITING_APPROVAL)->count()"></x-sidebar-link-content-mod>
            @endcan
            @can('viewAny', \App\Models\Presentation::class)
                <x-sidebar-link-content-mod
                    ...
                    :param="''"
                    :roleColour="Auth::user()->role_colour"
                    :badgeText="\App\Models\Presentation::hasStatus(ApprovalStatus::AWAITING_APPROVAL)->count()"></x-sidebar-link-content-mod>
            ...
            @can('viewAny', \App\Models\Booth::class)
                <x-sidebar-link-content-mod
                    ...
                    :param="''"
                    :roleColour="Auth::user()->role_colour"
                    :badgeText="\App\Models\Booth::hasStatus(ApprovalStatus::AWAITING_APPROVAL)->count()"></x-sidebar-link-content-mod>
            @endcan
            @can('viewAny', \App\Models\Sponsorship::class)
                <x-sidebar-link-content-mod
                    ...
                    :param="''"
                    :roleColour="Auth::user()->role_colour"
                    :badgeText="\App\Models\Company::hasStatus(ApprovalStatus::AWAITING_APPROVAL, 'sponsorship_approval_status')->count()"></x-sidebar-link-content-mod>
            @endcan
