...
{{--            :roleColour="'crew'"></x-sidebar-link-content-mod>--}}
        <x-sidebar-link-content-mod
            ...
            :param="''"
            :roleColour="'crew'"
            :badgeText="\App\Models\Company::where('is_approved', 0)->count()"></x-sidebar-link-content-mod>
        <x-sidebar-link-content-mod
            :label="'Presentations'"
            :route="'moderator.presentations.index'"
            :icon="'M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6'"
            :param="''"
            :roleColour="'crew'"
            :badgeText="\App\Models\Presentation::where('is_approved', 0)->count()"></x-sidebar-link-content-mod>
        <x-sidebar-link-content-mod
            :label="'Booths'"
            :route="'moderator.booths.index'"
            :icon="'M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72m-13.5 8.65h3.75a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75H6.75a.75.75 0 00-.75.75v3.75c0 .415.336.75.75.75z'"
            :param="''"
            :roleColour="'crew'"
            :badgeText="\App\Models\Booth::where('is_approved', 0)->count()"></x-sidebar-link-content-mod>
        <x-sidebar-link-content-mod
            :label="'Sponsorships'"
        ...
        <x-sidebar-link-content-mod
            :label="'Schedule management'"
            :route="'moderator.schedule.overview'"></x-sidebar-link-content-mod>
        <x-sidebar-link-content-mod
            :label="'Editions'"
        ...
        @if (Edition::current())
            <x-sidebar-link-content-mod
                :label="'Events'"
                :route="'moderator.events.index'"
                :param="Edition::current()"
                :icon="'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5'"
                :roleColour="'crew'"></x-sidebar-link-content-mod>
        @endif
    </ul>
