<div class="mx-20 my-20 p-10 bg-white dark:bg-gray-800">
    <div class="px-4 sm:px-0">
      <h3 class="text-base font-semibold leading-7 text-gray-900 dark:text-white">Booth details</h3>
      <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-500 dark:text-gray-300">Information about the booth that wants to join the
        booth area.</p>
    </div>
    <div class="mt-6 border-t border-gray-100 dark:border-gray-400">
      <dl class="divide-y divide-gray-100 dark:divide-gray-400">
        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          <dt class="text-sm font-medium leading-6 text-gray-900 dark:text-white">Booth name</dt>
          <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-200 sm:col-span-2 sm:mt-0">{{$boothName}}</dd>
        </div>
        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
        ...
        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-200 sm:col-span-2 sm:mt-0">{{$isSponsor}}</dd>
        </div>
        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          <dt class="text-sm font-medium leading-6 text-gray-900 dark:text-white">Additional Information</dt>
          <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-200 sm:col-span-2 sm:mt-0">{{$additionalInfo}}</dd>
        </div>
      </dl>
      <div class="flex">
