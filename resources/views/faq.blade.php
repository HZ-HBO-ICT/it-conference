        ...
        <div class="m-5 md:m-20">
            <dl class="grid-cols-1 gap-y-5 md:gap-x-10 md:gap-y-16 md:grid-cols-2 grid">
                <div class="border rounded border-gray-300 shadow p-4 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <dd class="leading-7 mt-2 dark:text-gray-200">The 'We are in IT together Conference' is an inclusive platform where students, teachers, and IT company representatives collaborate through workshops, presentations, and booths. This event promotes knowledge exchange, enabling students to explore the dynamic IT industry and providing companies opportunities to connect with potential employees, offer internships, and engage with the university's educational approach. If you want to know more, check out our <a href="https://www.youtube.com/@WeareInITTogether" target="_blank" class="text-blue-600 hover:text-blue-400 visited:text-purple-600">YouTube channel</a> and last year's <a href="https://www.youtube.com/watch?v=k-Psaz0hdQI" target="_blank" class="text-blue-600 hover:text-blue-400 visited:text-purple-600">impression video</a> about the Conference.</dd>
                </div>
                <div class="border rounded border-gray-300 shadow p-4 dark:bg-gray-800 dark:border-gray-700">
