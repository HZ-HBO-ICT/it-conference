                ...
                <div class="space-y-8">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:info@weareinittogether.nl" class="text-[#9333EA] hover:text-[#A855F7] transition-colors">
                    ...
                    <div class="bg-[#0B1221]/30 backdrop-blur-sm rounded-2xl p-8">
                        ...
                        <div class="flex space-x-6">
                            <a href="#" class="text-[#9333EA] hover:text-[#A855F7] transition-colors">
