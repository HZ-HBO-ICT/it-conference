<x-app-layout>
    <div style="overflow-x: hidden;"> {{--don't allow side scrolling--}}
        ...
        <div
            class="relative isolate py-80 bg-cover bg-center before:absolute before:inset-0 before:bg-gradient-to-br before:from-gradient-purple before:via-red-500 before:to-orange-500 before:opacity-70">
            <!-- Blob -->
