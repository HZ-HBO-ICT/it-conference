<x-action-section>
    ...
    <x-slot name="description">
        {{ __('Permanently remove the booth from this company') }}
    </x-slot>

    <x-slot name="content">
    {{ __('When deleted the company will no longer have a booth. However, the company representative is allowed to apply for another one.') }}
