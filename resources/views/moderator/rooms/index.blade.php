<x-content-moderator-layout>
    <div class="px-5 pt-5">
        ...
        <h1 class="text-4xl font-extrabold text-gray-700 dark:text-white py-5">Available rooms</h1>

        <a href="{{route('rooms.create')}}"
           class="text-center bg-crew-500 hover:bg-crew-600 text-white font-bold py-2 px-4 rounded">
            Add a new room
        </a>
        <div class="pr-7 py-5">
