    ...
    <div class="py-8 px-8 mx-auto max-w-7xl">
        ...
        <div class="pt-5">
                        ...
                        <div class="flex-col">
                            @if($sponsor->logo_path)
                                <img class="w-56 h-56 mx-auto my-auto max-w-full block dark:text-white"
                                     src="{{ url('storage/'. $sponsor->logo_path) }}" alt="Logo of {{$sponsor->name}}">
                            @else
            ...
            <x-action-section>
                ...
                @if(!$sponsor->is_sponsor_approved)
                    <x-slot name="actions">
                        <form method="POST" action="{{ route('moderator.sponsors.approve', $sponsor) }}" class="mr-2">
                            @csrf
