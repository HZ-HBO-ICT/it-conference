<x-hub-layout>
    ...
    <h1 class="text-4xl font-extrabold text-gray-700 dark:text-white ml-4 py-5">Presentations</h1>
    <div class="pr-12 pl-4">
        <h2 class="text-2xl text-gray-700 dark:text-white">Overview of all the presentations awaiting approval or already approved</h2>
                        ...
                        @forelse($presentations as $index => $presentation)
                            <li>
                                <a href="{{route('moderator.presentations.show', $presentation)}}" class="block">
                                    <div class="px-6 py-6 {{ !$presentation->is_approved ? 'bg-red-300 dark:bg-red-800' : '' }} hover:bg-crew-100 dark:hover:bg-slate-600">
                                        <div class="justify-between flex mt-2">
                                            <div class="flex">
                                                <div class="text-gray-700 dark:text-white text-m items-center flex">
<svg class="shrink-0 w-6 h-6 mr-1.5 block stroke-crew-400 {{ !$presentation->is_approved ? 'stroke-crew-900 dark:stroke-crew-900 hover:stroke-crew-500' : '' }}" xlmns="http://www.w3.org/2000/svg" viewbox="0 0 23 23" fill="none" aria-hidden="true">
