...
export default {
    ...
    safelist: [
        ...
        'bg-apricot-peach-400',
        'bg-apricot-peach-500',
        'bg-apricot-peach-600',
        'bg-partner-400',
        'bg-partner-500',
        'bg-partner-600',
        ...
        'bg-partner-300',
        'bg-participant-300',
        'hover:bg-partner-500',
        'hover:from-participant-400',
        'hover:from-participant-500',
        'hover:to-participant-600',
        'hover:to-participant-700',
        'hover:from-violet-400',
        'hover:from-violet-500',
        'hover:to-violet-600',
        'hover:to-violet-700',
        'hover:from-partner-400',
        'hover:from-partner-500',
        'hover:to-partner-600',
        'hover:to-partner-700',
        'hover:from-blue-400',
        'hover:from-blue-500',
        'hover:to-blue-600',
        'hover:to-blue-700',
        'hover:from-apricot-peach-400',
        'hover:from-apricot-peach-500',
