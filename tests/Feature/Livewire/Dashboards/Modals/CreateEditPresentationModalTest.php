...
class CreateEditPresentationModalTest extends TestCase
{
    ...
    #[Test]
    public function test_that_it_can_mount_the_component_only_with_user_for_creating()
    {
    ...
    #[Test]
    public function test_that_it_can_mount_the_component_with_user_and_presentation_for_editing()
    {
        $company = Company::factory()->create(['approval_status' => ApprovalStatus::APPROVED->value]);
    ...
    #[Test]
    public function test_it_throws_authorization_error_when_user_doesnt_have_permission() {
        $company = Company::factory()->create(['approval_status' => ApprovalStatus::APPROVED->value]);
        $presentation = Presentation::factory()->create(['company_id' => $company->id]);
    ...
    #[Test]
    public function test_it_validates_input_fields_when_creating_presentation()
    {
        $company = Company::factory()->create(['approval_status' => ApprovalStatus::APPROVED->value]);
        $user = User::factory()->create(['company_id' => $company->id]);
        $user->assignRole('company representative');
    ...
    #[Test]
    public function test_it_validates_input_fields_when_editing_presentation()
    {
        $company = Company::factory()->create(['approval_status' => ApprovalStatus::APPROVED->value]);
        $presentation = Presentation::factory()->create(['company_id' => $company->id]);
        $user = User::factory()->create(['company_id' => $company->id]);
    ...
    #[Test]
    public function test_it_creates_presentation_with_valid_input()
    {
        $company = Company::factory()->create(['approval_status' => ApprovalStatus::APPROVED->value]);
        $user = User::factory()->create(['company_id' => $company->id]);
        $user->assignRole('company representative');
        ...
        $presentationType = PresentationType::first();
    ...
    #[Test]
    public function test_it_updates_presentation_with_valid_input()
    {
        $company = Company::factory()->create(['approval_status' => ApprovalStatus::APPROVED->value]);
        $presentation = Presentation::factory()->create(['company_id' => $company->id]);
        $user = User::factory()->create(['company_id' => $company->id]);
        ...
        $newType = PresentationType::first();
        $newDifficulty = Difficulty::first();
